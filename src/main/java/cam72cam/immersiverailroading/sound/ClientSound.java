...
public class ClientSound implements ISound {
	...
	public void play(Vec3d pos) {
		...
		} else if (new Vec3d(Minecraft.getMinecraft().thePlayer.posX, Minecraft.getMinecraft().thePlayer.posY, Minecraft.getMinecraft().thePlayer.posZ).distanceTo(currentPos) < this.attenuationDistance * 1.1) {
			sndSystem.get().play(id);
		}
	}
