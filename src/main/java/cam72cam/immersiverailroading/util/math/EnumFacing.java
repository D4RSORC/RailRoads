...
public enum EnumFacing implements IStringSerializable
{
    ...
    public static EnumFacing getDirectionFromEntityLiving(BlockPos pos, EntityLivingBase placer)
    {
        ...
        return getHorizontalFacing(placer).getOpposite();
    }
    ...
    public static EnumFacing getHorizontalFacing(EntityLivingBase placer)
    {
        return EnumFacing.getHorizontal(MathHelper.floor_double((double)(placer.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3);
    }
}